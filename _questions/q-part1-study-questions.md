...
A. Opal, whose marriage was annulled, but not until January 1 of the following tax year.  
...
A. She can choose to file Married Filing Jointly OR Married Filing Separately.  
...
B. Lacie cannot use the standard deduction; she must itemize her deductions.  
...
A.Layla is not required to pay estimated taxes.  
...
A. She must fill out a W-7 application form for an ITIN, and submit it to the IRS along with a completed tax return.  
...
A. Married taxpayers who are living in the same household.  
B. No longer married.  
...
C. She can choose to file Head of Household or Married Filing Separately.  
...
D. The IRS must assess additional tax within three years from the received date of Percy's tax return.  
...
D. The preparer must inform the taxpayer of the error and its potential consequences. However, the preparer is not obligated to correct the error.  
...
D. They need to adjust their withholding using Form W-4, then give the form to their employer.  
...
A. Halton, whose annulment was finalized on January 10, 2024.  
...
C. The taxpayer requesting relief still living with his or her spouse.
D. None of the above.  
...
A. Orville may request injured spouse relief.  
...
B. Yes, both must file, because they have chosen to file separate returns (MFS).  
